...
window.SITE_DATA = {
  profile: {
    ...
    portrait: "assets/profile/khandoker-tanjim-ahammad.webp",
    portraitAlt: "Professional portrait of Khandoker Tanjim Ahammad",
    headline:
      "Doctoral researcher developing practical imaging, robotics, and automation systems for agricultural research.",
    introduction:
      "I am a doctoral researcher at the University of Hohenheim, working at the intersection of agricultural engineering, plant phenotyping, computer vision, and robotics. My research develops reliable methods for extracting meaningful plant and crop traits from UAV thermal and RGB imagery, LiDAR, depth and hyperspectral data, three-dimensional measurements, and automated phenotyping systems.",
    teachingSummary:
      "Guest Lecturer in Robotics in Agriculture and Renewable Energy and Sustainable Energy in Agriculture.",
    availability:
      "Open to scientific collaboration, interdisciplinary projects, and applied engineering partnerships.",
    links: {
  ...
  researchFocus: [
    ...
    {
      title: "Robotics, sensors & autonomous phenotyping",
      text:
        "ROS 2-based integration of robot models, motion systems, and scientific sensors for repeatable plant measurements. This work combines RViz and MoveIt 2 with RGB, thermal, hyperspectral, LiDAR, depth, and RGB-D sensors in modular phenotyping platforms."
    },
    {
      title: "Multimodal plant sensing",
      text:
        "RGB, thermal, LiDAR, depth, multispectral, and hyperspectral data analysis for non-destructive assessment of plant structure, canopy geometry, stress, and nutrient response."
    }
  ],
  ...
  currentWork: [
    ...
    },
    {
      ...
      description:
        "Developing modular robotic workflows for agricultural imaging and phenotyping using ROS 2. The work combines robot-model visualization in RViz, motion-planning workflows with MoveIt 2, and synchronized acquisition from RGB, thermal, hyperspectral, LiDAR, depth, and RGB-D sensors for repeatable experimental operation."
    },
    {
  ...
  teaching: [
    {
      role: "Guest Lecturer",
      module: "Robotics in Agriculture",
      institution: "University of Hohenheim",
      description:
        "Guest teaching contribution to a course module focused on robotics applications, sensing, automation, and intelligent systems in agriculture."
    },
    {
      role: "Guest Lecturer",
      module: "Renewable Energy and Sustainable Energy in Agriculture",
      institution: "University of Hohenheim",
      description:
        "Guest teaching contribution to a course module focused on renewable-energy technologies and sustainable energy applications in agricultural systems."
    }
  ],
  ...
  projects: [
    {
      ...
      description:
        "A modular robotics workflow for integrating robot-state visualization, motion planning, scientific cameras, synchronized sensor acquisition, and automated plant-measurement procedures.",
      technologies: [
        "ROS 2",
        "RViz",
        "MoveIt 2",
  ...
  skills: {
    ...
    "Teaching & academic engagement": [
      ...
      "Renewable Energy and Sustainable Energy in Agriculture",
