...
window.SITE_DATA = {
  profile: {
    ...
    headline: "Imaging, computer vision, and intelligent sensing for agricultural systems.",
    introduction:
      "I develop reproducible imaging and automation methods for agricultural research. My work combines drone-based thermal and RGB sensing, depth and hyperspectral imaging, computer vision, deep learning, robotics, and modular phenotyping platforms to convert complex sensor data into reliable biological and engineering measurements.",
    availability: "Open to scientific collaboration and applied research partnerships.",
    links: {
      github: "https://github.com/Khandoker09",
      linkedin: "https://www.linkedin.com/in/khandokerahammad/",
      scholar: "https://scholar.google.com/citations?hl=en&user=GxGxFgcAAAAJ",
      researchgate: "https://www.researchgate.net/profile/Khandoker_Tanjim_Ahammad"
    }
  },
  ...
  researchFocus: [
    {
      ...
      text: "Drone-based image acquisition and analysis for crop monitoring, canopy temperature assessment, spatial variability, and field-scale phenotyping."
    },
    {
      title: "Computer vision & deep learning",
      text: "Segmentation, detection, reconstruction, measurement, and classification methods for extracting repeatable traits from scientific images."
    },
    {
      title: "Robotics & phenotyping platforms",
      text: "Sensor integration and automation workflows for consistent plant measurements in laboratory, greenhouse, and field experiments."
    },
    {
      title: "Multimodal plant sensing",
      text: "RGB, thermal, depth, multispectral, and hyperspectral data analysis for non-destructive assessment of plant structure, stress, and nutrient response."
    }
  ],
  ...
  currentWork: [
    ...
    {
      area: "Automation",
      title: "Robotics and modular phenotyping platforms",
      description:
        "Integrating cameras, sensors, motion systems, and software pipelines to improve measurement consistency, throughput, traceability, and repeatability in agricultural experiments."
    },
    {
  ...
  credentials: [
    {
      ...
      note: "The registration number and certificate QR code are intentionally omitted from the public website.",
      verificationUrl: ""
    }
  ],
  ...
  posters: [
    {
      year: "2026",
      title: "Benchmarking Depth-Sensor 3D Phenotyping of Maize Cobs Against 2D Image and Geometric Methods",
      ...
      image: "assets/posters/maize-cob-3d-depth-phenotyping-cigr-2026.jpg",
      pdf: "assets/posters/maize-cob-3d-depth-phenotyping-cigr-2026.pdf",
      external: ""
    },
    {
      year: "2026",
      title: "Semi-empirical prediction of dust soiling effects on Agri-PV output power: Particle size effect and implications for adaptive maintenance",
      event: "ACRIUC 2026 research poster",
      authors: "Khandoker Tanjim Ahammad, Janvier Ntwali, Wiomou Joévin Bonzi, Joachim Müller",
      summary:
    ...
    {
      year: "2025",
      title: "Detecting phosphorus deficiency in maize plant leaves using hyperspectral imaging",
      ...
      image: "assets/posters/phosphorus-deficiency-maize-hyperspectral-2025.jpg",
      pdf: "assets/posters/phosphorus-deficiency-maize-hyperspectral-2025.pdf",
      external: "https://www.tropentag.de/2025/abstracts/abstracts.php?showtime=0&noID=422"
    }
  ],
  ...
  conferenceContributions: [
    {
      ...
      url: "https://www.tropentag.de/submission/abstractlist/abstract_list.php?Name=Khandoker+Tanjim+Ahammad&personID=434&upload=poster"
    }
  ],
  ...
  publications: [
    {
      ...
      venue: "3rd IEEE International Conference on Electrical Information and Communication Technology",
    ...
    },
    {
      year: "2017",
      type: "Journal article",
      title: "Hand gesture detection using Haar classifier with appropriate skin color, kernel sizing and automatic thresholding",
  ...
  projects: [
    {
      ...
      description: "A Streamlit application for exploring, checking, summarising, and visualising CSV and Excel datasets.",
      technologies: ["Python", "Pandas", "Streamlit"],
      url: "https://github.com/Khandoker09/SaVeDv0.1"
    },
    {
      title: "DaZ - interactive dataset editor",
      description: "A browser-based dashboard for filtering, editing, cleaning, and exporting tabular data.",
      technologies: ["Python", "Dash", "Plotly"],
      url: "https://github.com/Khandoker09/daZ-v0.2"
    },
    {
      title: "Parking-space monitor",
      description: "An OpenCV prototype that analyses video to count occupied and available parking spaces.",
  ...
  education: [
    {
      ...
      detail: "Agricultural engineering research focused on imaging, automation, and plant phenotyping."
    },
    {
      year: "2024",
      degree: "MSc, Microsystems and Microelectronics",
      institution: "Hamburg University of Technology (TUHH)",
      detail: "Master's thesis on deep-learning-based noise detection in high-density point-cloud measurements from white-light interferometry."
    },
    {
      year: "2016",
      degree: "BSc, Electrical and Electronic Engineering",
      institution: "American International University-Bangladesh",
      detail: "Electrical engineering, electronics, image data, biomedical systems, and robotics."
    }
  ],

  skills: {
    "Imaging & sensing": ["UAV thermal imaging", "RGB imaging", "Depth sensing", "Hyperspectral imaging", "Point clouds", "Image calibration"],
    "AI & computer vision": ["Segmentation", "Object detection", "Classification", "Deep learning", "3D reconstruction", "Feature extraction"],
    "Agricultural engineering": ["Plant phenotyping", "Agri-PV systems", "Robotics", "Sensor integration", "Experiment workflows", "Data pipelines"],
    "Software": ["Python", "PyTorch", "TensorFlow", "OpenCV", "Pandas", "Git"]
  }
};
